 ...
 * To create another configuration set just copy this file to config.php etc. You get the idea :)
 */
 ...
 */
 ...
 // here we define the package name of our application
define('PACKAGE','rhema');
 ...
 */
 return array(
     ...
     * If a mail server is set up and you know
     * what to do, then please set EMAIL_USE_SMTP to true
     * and fill in the SMTP provider account data.
     *
